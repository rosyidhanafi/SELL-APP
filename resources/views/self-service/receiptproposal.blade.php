...
<div class="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-2xl p-8 border-2 border-slate-300" id="receiptContent">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6 text-sm">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-slate-800">OTS</p>
                </div>
                <div>
            ...
            <div class="text-center text-slate-600 text-sm space-y-2">
                <p class="text-xl font-bold text-slate-800 my-2">TERIMA KASIH</p>
                <p>Tanggal: {{ $transaction->created_at->format('d/m/Y H:i:s') }}</p>
                <p class="text-sm underline text-slate-500">Perlihatkan ID Transaksi pada kasir untuk melakukan pembayaran, <br> pastikan nominal seusai</p>
            </div>
        </div>
        ...
        <div class="flex gap-4 mt-8 justify-center">
            ...
            <a href="{{ route('self_service.index') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
