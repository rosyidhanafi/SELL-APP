        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                <h1 class="text-4xl font-bold text-slate-800 uppercase">Form Edit | <span
                        class="bg-blue-500 px-2 py-0.5 text-white rounded-md shadow-md relative">Produk<span
                            class="text-xs bg-orange-400 py-0.5 px-1 rounded-md text-white shadow-md absolute -top-2 -right-4 rotate-12">Admin</span></span>
                </h1>
                <p class="text-slate-600 mt-2">Masukkan data produk yang ingin diubah</p>
                <hr class="my-4">
                <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="space-y-6"
                    ...
                    <!-- Nama Produk -->
                    <div class="">
                        <input type="file" value="{{ old('image_product_path', $product->image_product_path) }}"
                            class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            name="image_product_path" id="image_product_path">
                    </div>
                    ...
                    <div class="flex gap-4 pt-6 border-t border-slate-200">
                        <button type="submit"
                            class="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 flex items-center justify-center gap-2">
