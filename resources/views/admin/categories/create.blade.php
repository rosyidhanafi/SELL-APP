    ...
    <div class="min-h-screen p-6 relative">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                <h1 class="text-4xl font-bold text-slate-800">Form Tambah | <span
                        class="bg-orange-500 px-2 py-0.5 rounded-md shadow-md text-white relative">Kategori</span></h1>
                <p class="text-slate-600 mt-2">Buat kategori produk yang baru</p>
                <hr class="my-4">
            ...
            <!-- Info Box -->
            <div class="mt-6 absolute left-24 w-60 top-36 text-lg bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                <p class="text-blue-800 font-semibold animate-pulse bg-orange-300 inline-block px-2">Informasi Slug:</p>
